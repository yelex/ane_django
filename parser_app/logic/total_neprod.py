...
from .handlers.ozon_handler import OzonHandler
from .handlers.lamoda_handler import LamodaHandler
from .handlers.piluli_handler import PiluliHandler
...
class TotalNongrocery():
    ...
    def get_df(self):
        ...
        site_handlers = [LamodaHandler(), PiluliHandler(), OzonHandler()]  #
